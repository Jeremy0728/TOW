...
Los nodos no exponen variables Figma publicadas para esta inspeccion. La implementacion debe derivar tokens desde capas, screenshot y contexto de diseno.
...
- Supporting copy references Leadz foundation: restrained cards, lime/yellow actions and deep financial contrast.
- Three cards:
...
Los URLs temporales de assets Figma vencen. Si se descargan, guardarlos con nombres estables en `images/figma/` y registrar el origen.
